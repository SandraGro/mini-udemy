...
function CourseDetail(props) {
  ...
  let featureCourse;
  for (let course of props.featuredCourses) {
      ...
      <div className="py-5 top-container">
        <div className="title-container">
          ...
          <div className="rating-container">
            {featureCourse.bestseller ?  <Badge variant="warning">Bestseller</Badge> : ""}
